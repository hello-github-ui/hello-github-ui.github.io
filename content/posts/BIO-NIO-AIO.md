...
Java BIO是传统的Java io编程，[相关的类和接口在java.io](http://相关的类和接口在java.io)包中
    ...
    public static void handler(Socket socket) {
        ...
        try {
            ...
            while (true) {
                ...
                int read = [inputStream.read](http://inputStream.read)(bytes);
...
public class OldIOClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while ((readCount = [inputStream.read](http://inputStream.read)(buffer)) >= 0) {
...
NIO 相关类都被放在 java.nio 包及子包下，并且对原 [java.io](http://java.io) 包中的很多类进行了改写。
...
public class NIOFileChannel03 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            int read = [inputStreamChannel.read](http://inputStreamChannel.read)(byteBuffer);
...
public class NIOServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ServerSocketChannel serverSocketChannel = [ServerSocketChannel.open](http://ServerSocketChannel.open)();

        // 创建selector

        Selector selector = [Selector.open](http://Selector.open)();
        ...
        while (true) {
            ...
            if ([selector.select](http://selector.select)(1000) == 0) {
            ...
            while (keyIterator.hasNext()) {
                ...
                SelectionKey key = [keyIterator.next](http://keyIterator.next)();
                ...
                if (key.isReadable()) {
                    ...
                    SocketChannel channel = (SocketChannel) [key.channel](http://key.channel)();

                    // 获取到管理的Buffer

                    ByteBuffer buffer = (ByteBuffer) key.attachment();

                    [channel.read](http://channel.read)(buffer);
...
public class NIOClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SocketChannel socketChannel = [SocketChannel.open](http://SocketChannel.open)();
